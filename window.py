...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/circle.png"))
        # 图片读取进程
        ...
        self.model = self.model_load(weights="weight/yolov5s.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap("images/UI/picture.png"))
        self.right_img.setPixmap(QPixmap("images/UI/help.png"))
        ...
        self.vid_img = QLabel()
        self.vid_img.setPixmap(QPixmap("images/UI/camera.png"))
        ...
        self.setTabIcon(0, QIcon('images/UI/circle.png'))
        self.setTabIcon(1, QIcon('images/UI/circle.png'))
        #self.setTabIcon(2, QIcon('images/UI/circle.png'))
                ...
                if len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        if save_img or save_crop or view_img:  # Add bbox to image
                            c = int(cls)  # integer class
                            if conf >= 0.6:
                                if names[int(cls)] == "car" or names[int(cls)] == "bus" or names[int(cls)] == "bicyle" or names[int(cls)] == "motorcycle" or names[int(cls)] == "truck":
                                    label = None if hide_labels else (names[c] if hide_conf else f'{names[c]} {conf:.2f}')
                                    annotator.box_label(xyxy, label, color=colors(c, True))
                                    # if save_crop:
                                    #     save_one_box(xyxy, imc, file=save_dir / 'crops' / names[c] / f'{p.stem}.jpg',
